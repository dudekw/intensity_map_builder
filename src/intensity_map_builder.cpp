...
{
   my_file<<"in visualizationInitialization\n";
   my_file<<"marker_id: "<<marker_id<<"\n";
   my_file<<"positions.size = "<<positions.size()<<"\n";
...
void IntensityMapBuilder::updateMapMarkers(const intensity_map_msgs::IntensityMarker& markers_msg, tf::StampedTransform &tf_transform)
{
  ...
  my_file <<"Using localization transform:"<<"\n"; 
  my_file <<odom_transform<<"\n";
  ...
  visualizationInitialization(vis_map_markers, map_marker_counter, map_positions, vis_color, "map", "map_markers");
